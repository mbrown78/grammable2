...
RSpec.describe GramsController, type: :controller do
  ...
  describe "grams#destroy" do
    ...
    it "shouldnt let unauthenticated user destroy a gram" do 
      p = FactoryGirl.create(:gram)
      delete :destroy, id: p.id
    ...
    it "should return a 404 message if we cannot find a gram with the id that is specified" do
      ...
      sign_in u   #different syntax here 
  ...
  describe "grams#update" do
    ...
    it "shouldnt let unauthenticated user update a gram" do 
    ...
    it "should have http 404 error if the gram cannot be found" do
       u = FactoryGirl.create(:user)
       sign_in u  #syntax here
       
       patch :update, id: "YOLOSWAG", gram: {message: 'Changed'}  #cause id is not a number?
       expect(response).to have_http_status(:not_found)
    end

    it "should render the edit form with an http status of unprocessable_entity if data is not valid" do
      p = FactoryGirl.create(:gram, message: "Initial Value")
      sign_in p.user
  ...
  describe "grams#edit action" do
    ...
    it "should successfully show the edit form if the gram is found" do
      p = FactoryGirl.create(:gram)  #why do we need to create the gram here?
      sign_in p.user
      get :edit, id: p.id
  ...
  describe "grams#create action" do
    ...
    it "should successfully create a new gram in our database" do
      ...
      gram = Gram.last
      expect(gram.message).to eq("Hello!")  #syntax analysis
